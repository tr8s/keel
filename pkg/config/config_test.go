...
func TestLoadMapsEveryTypedPath(t *testing.T) {
	...
	values := map[string]string{
		...
		"NOTIFICATION_LEVEL": "warn", "WEBHOOK_ENDPOINT": "https://webhook", "SLACK_BOT_TOKEN": "xoxb-typed", "SLACK_APP_TOKEN": "xapp-typed", "SLACK_BOT_NAME": "typed-bot", "SLACK_CHANNELS": "one,two", "SLACK_APPROVALS_CHANNEL": "approvals", "SLACK_APPROVAL_HIDE_COMMANDS": "true", "SLACK_APPROVAL_COMPACT": "true", "SLACK_APPROVAL_MIGRATION_NOTE": "Migrations run when the new pods start.", "SLACK_DEPLOY_NOTICES": "true", "SLACK_DEPLOY_NOTICES_MENTION": "<!here>",
	...
	require.Equal(t, Config{
		...
		Bots:          BotConfig{Slack: SlackBotConfig{BotToken: "xoxb-typed", AppToken: "xapp-typed", BotName: "typed-bot", ApprovalsChannel: "approvals", HideApprovalCommands: true, CompactApprovals: true, ApprovalMigrationNote: "Migrations run when the new pods start.", DeployNotices: true, DeployNoticesMention: "<!here>"}, Hipchat: HipchatBotConfig{ApprovalsChannel: "hip-approvals", ApprovalsUserName: "hip-user", ApprovalsBotName: "hip-bot", ApprovalsPassword: "hip-pass", ConnectionAttempts: 4}},
