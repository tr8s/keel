...
func TestLoadMapsEveryTypedPath(t *testing.T) {
	...
	values := map[string]string{
		...
		"NOTIFICATION_LEVEL": "warn", "WEBHOOK_ENDPOINT": "https://webhook", "SLACK_BOT_TOKEN": "xoxb-typed", "SLACK_APP_TOKEN": "xapp-typed", "SLACK_BOT_NAME": "typed-bot", "SLACK_CHANNELS": "one,two", "SLACK_APPROVALS_CHANNEL": "approvals", "SLACK_APPROVAL_HIDE_COMMANDS": "true", "SLACK_APPROVAL_COMPACT": "true",
