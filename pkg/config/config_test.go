...
func TestLoadMapsEveryTypedPath(t *testing.T) {
	...
	require.Equal(t, Config{
		...
		Bots:          BotConfig{Slack: SlackBotConfig{BotToken: "xoxb-typed", AppToken: "xapp-typed", BotName: "typed-bot", ApprovalsChannel: "approvals", HideApprovalCommands: true, CompactApprovals: true, ApprovalMigrationNote: "Migrations run when the new pods start."}, Hipchat: HipchatBotConfig{ApprovalsChannel: "hip-approvals", ApprovalsUserName: "hip-user", ApprovalsBotName: "hip-bot", ApprovalsPassword: "hip-pass", ConnectionAttempts: 4}},
